    ...
    return (
        <div>
            ...
            <div onClick={() => {
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare?.car ?? "NA"}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanelOpen(true)
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare?.moto ?? "NA"}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanelOpen(true)
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare?.auto ?? "NA"}</h2>
            </div>
        </div>
    )
}
